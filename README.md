...
- **Goodhart's Law:** The rolling correlation between DAU/MAU and time per session flipped sign — from **+0.93** in the organic phase to **−0.96** in the gaming phase — confirming that once DAU/MAU became a targeted proxy, gains in session frequency came directly at the expense of session depth, the canonical signature of Goodhart's Law in action.
